...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark sb-nav fixed-top\">\n    <div class=\"container sb-nav-inner\">\n        <a class=\"navbar-brand sb-brand\" href=\"#\">SkillBrain Deli</a>\n        <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\"\n                data-target=\"#navbarResponsive\" aria-controls=\"navbarResponsive\"\n                aria-expanded=\"false\" aria-label=\"Toggle navigation\" (click)=\"toggleCollapsed()\">\n            <span class=\"navbar-toggler-icon\"></span>\n        </button>\n        <div id=\"navbarResponsive\" [ngClass]=\"{'collapse': collapsed, 'navbar-collapse': true}\">\n            <ul class=\"navbar-nav ml-auto\">\n                <li class=\"nav-item active\">\n                    <a class=\"nav-link sb-nav-link\" href=\"#\" (click)=\"reset()\">Catalog\n                        <span class=\"sr-only\">(current)</span>\n                    </a>\n                </li>\n            </ul>\n        </div>\n    </div>\n</nav>\n\n<div class=\"sb-page container\">\n    <section class=\"sb-hero\">\n        <div class=\"sb-hero-copy\">\n            <p class=\"sb-eyebrow\">SkillBrain x Deli</p>\n            <h1>Gust rapid, comanda clara.</h1>\n            <p class=\"sb-hero-text\">\n                Selectie de carnati artizanali, pachete curate si flux complet de comanda pentru demo SkillBrain.\n            </p>\n            <div class=\"sb-hero-actions\">\n                <button class=\"btn btn-primary sb-hero-btn\" (click)=\"reset()\">Vezi produsele</button>\n                <span class=\"sb-hero-note\">Livrare rapida, stoc actualizat zilnic.</span>\n            </div>\n        </div>\n        <div class=\"sb-hero-card\">\n            <div class=\"sb-hero-metric\">\n                <span class=\"sb-hero-value\">6</span>\n                <span class=\"sb-hero-label\">retete</span>\n            </div>\n            <div class=\"sb-hero-metric\">\n                <span class=\"sb-hero-value\">15</span>\n                <span class=\"sb-hero-label\">minute ridicare</span>\n            </div>\n            <div class=\"sb-hero-metric\">\n                <span class=\"sb-hero-value\">100%</span>\n                <span class=\"sb-hero-label\">lot proaspat</span>\n            </div>\n        </div>\n    </section>\n\n    <div class=\"sb-layout\" [class.sb-hidden]=\"orderFinished\">\n        <div class=\"sb-products\">\n            <app-products #productsC [hidden]=\"orderFinished\"></app-products>\n        </div>\n        <div class=\"sb-cart\">\n            <app-shopping-cart (onOrderFinished)=finishOrder($event) #shoppingCartC\n                               [hidden]=\"orderFinished\"></app-shopping-cart>\n        </div>\n    </div>\n\n    <div class=\"sb-orders\" [hidden]=\"!orderFinished\">\n        <app-orders #ordersC></app-orders>\n    </div>\n</div>\n"
...
module.exports = "<div class=\"sb-card sb-orders-card\">\n    <div class=\"sb-card-header\">\n        <div>\n            <p class=\"sb-card-eyebrow\">Finalizare</p>\n            <h2 class=\"sb-section-title\">Plasarea comenzii</h2>\n        </div>\n    </div>\n    <div class=\"sb-card-body\">\n        <ul class=\"sb-list\">\n            <li *ngFor=\"let order of orders.productOrders\">\n                <span>{{ order.product.name }}</span>\n                <span class=\"sb-pill\">{{ order.product.price }} lei x {{ order.quantity }} buc.</span>\n            </li>\n        </ul>\n        <div class=\"sb-total-line\">\n            <span>Cost total</span>\n            <strong>{{ total }} lei</strong>\n        </div>\n\n        <button class=\"btn btn-primary btn-block sb-btn\" (click)=\"pay()\" *ngIf=\"!paid\">Plateste</button>\n\n        <div class=\"sb-alert\" role=\"alert\" *ngIf=\"paid\">\n            <strong>Excelent!</strong> Comanda a fost inregistrata.\n        </div>\n    </div>\n</div>\n"
...
module.exports = "<div class=\"sb-products-grid\">\n    <div class=\"sb-product-card\" *ngFor=\"let order of productOrders\">\n        <div class=\"sb-product-header\">\n            <h4 class=\"sb-product-title\">{{order.product.name}}</h4>\n            <span class=\"sb-product-price\">{{order.product.price}} lei</span>\n        </div>\n        <div class=\"sb-product-media\">\n            <img class=\"sb-product-image\" src={{order.product.pictureUrl}} alt=\"\">\n        </div>\n        <div class=\"sb-product-actions\">\n            <div class=\"sb-quantity\" *ngIf=\"!isProductSelected(order.product)\">\n                <label class=\"sb-quantity-label\">Cantitate</label>\n                <input type=\"number\" min=\"1\" class=\"form-control sb-quantity-input\" [(ngModel)]=order.quantity>\n            </div>\n            <button class=\"btn btn-primary sb-btn\" (click)=\"addToCart(order)\"\n                    [disabled]=\"order.quantity <= 0\" *ngIf=\"!isProductSelected(order.product)\">Adauga in cos\n            </button>\n            <button class=\"btn btn-outline sb-btn\" *ngIf=\"isProductSelected(order.product)\"\n                    (click)=\"removeFromCart(order)\">Scoate din cos\n            </button>\n        </div>\n    </div>\n</div>\n"
...
var ProductsComponent = /** @class */ (function () {
    ...
    ProductsComponent.prototype.loadProducts = function () {
        ...
        this.ecommerceService.getAllProducts()
            ...
            window.alert('Site-ul este in mentenanta. Reveniti mai tarziu!');
            console.log(error);
        });
    };
...
module.exports = "<div class=\"sb-card sb-cart-card\">\n    <div class=\"sb-card-header\">\n        <div>\n            <p class=\"sb-card-eyebrow\">Cos</p>\n            <h3 class=\"sb-card-title\">Comanda ta</h3>\n        </div>\n        <span class=\"sb-badge\">{{ orders.productOrders.length }}</span>\n    </div>\n    <div class=\"sb-card-body\">\n        <div class=\"sb-total-line\">\n            <span>Total</span>\n            <strong>{{ total }} lei</strong>\n        </div>\n        <p class=\"sb-muted\">Produse in cos</p>\n\n        <ul class=\"sb-list\">\n            <li *ngFor=\"let order of orders.productOrders\">\n                <span>{{ order.product.name }}</span>\n                <span class=\"sb-pill\">{{ order.quantity }} buc.</span>\n            </li>\n        </ul>\n\n        <button class=\"btn btn-primary btn-block sb-btn\" (click)=\"finishOrder()\"\n                [disabled]=\"orders.productOrders.length == 0\">Finalizeaza comanda\n        </button>\n    </div>\n</div>\n"
...
module.exports = __webpack_require__(/*! /home/okami312/Downloads/Sausage-Store-Skillbrain/sausage-store/frontend/src/main.ts */"./src/main.ts");
